...
Route::group(['prefix' => 'bendahara'], function() {
    ...
    Route::get('/new', 'BendaharaController@create');
    Route::post('/', 'BendaharaController@save');
    Route::get('/{id}', 'BendaharaController@edit');
    Route::put('/{id}', 'BendaharaController@update');
    Route::delete('/{id}', 'BendaharaController@destroy');
});
