...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">Aplikasi <span class="lite">Invoice</span></a>
      <!--logo end-->
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <li class="active">
            <a class="" href="{{ url('/bendahara') }}">
                          <i class="icon_send_alt"></i>
                          <span>Bendahara</span>
                      </a>
          </li>

            <ul class="sub">
              <li><a class="" href="{{ route('invoice.create') }}">Buat Invoice</a></li>
              <li><a class="" href="{{ route('invoice.index') }}">List Invoice</a></li>
            </ul>
          </li>
        </ul>
        <!-- sidebar menu end-->
